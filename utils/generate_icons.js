...
async function generateIcons() {
  try {
    ...
    // 3. Generate apple-touch-icon.png (180x180, no transparency, solid background)
    // Note: Since our source SVG already has a solid #020617 background, simply rasterizing
    // it without any transparency layer makes it perfect for iOS.
    await sharp(svgPath)
      .resize(180, 180)
